...
6. ~~`order-received.html` is still static/unwired to real order data~~ **Fixed 2026-08-11** — see section 8. Both this and `account-order-details.html` are now wired to real orders.
