...
- **Not yet independently confirmed working end-to-end**: a real order hasn't yet been placed successfully through the storefront checkout since fix #4 — next test should be pulling latest and actually completing a checkout, not just clearing the last error.
